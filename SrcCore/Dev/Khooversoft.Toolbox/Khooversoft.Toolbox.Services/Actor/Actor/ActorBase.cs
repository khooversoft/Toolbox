...
namespace Khooversoft.Toolbox.Actor
{
    ...
    public abstract class ActorBase : IActorBase
    {
        ...
        public ActorBase(ActorKey actorKey, IActorManager actorManager)
        {
            ...
            ActorManager.Configuration.ActorCreated(_workContext.WithTag(_tag), ActorKey, this.GetType());
        }
        ...
        public async Task ActivateAsync(IWorkContext context)
        {
            ...
            ActorManager.Configuration.ActorActivate(context.WithTag(_tag), ActorKey, this.GetType());
        ...
        public async Task DeactivateAsync(IWorkContext context)
        {
            ...
            ActorManager.Configuration.ActorDeactivate(context.WithTag(_tag), ActorKey, this.GetType());
            StopTimer();
        ...
        public void StopTimer()
        {
            ...
            {
                t.Dispose();
                ActorManager.Configuration.ActorStopTimer(_workContext.WithMethodName(), ActorKey);
            }
        }
