...
namespace Khooversoft.Toolbox.Actor
{
    ...
    public class ActorRepository : IActorRepository
    {
        ...
        public async Task ClearAsync(IWorkContext context)
        {
            ...
            context.EventLog.Verbose(context.WithTag(_tag), "Clearing actor container");
        ...
        public async Task<IActorRegistration> RemoveAsync(IWorkContext context, Type actorType, ActorKey actorKey)
        {
            ...
            context.EventLog.Verbose(context.WithTag(_tag), $"Removing actor {actorKey}");
        ...
        private void GarbageCollection(object obj)
        {
            ...
            try
            {
                _workContext.EventLog.Verbose(_workContext.WithTag(_tag), "GarbageCollection");
