...
namespace Khooversoft.Toolbox.Actor
{
    public class ActorManagerBuilder : IActorConfiguration
    {
        ...
        public ActorManagerBuilder Set(IWorkContext context)
        {
            WorkContext = context;
            return this;
        }
        ...
        {
            Verify.IsNotNull(nameof(ActorRepository), ActorRepository);
            Verify.IsNotNull(nameof(WorkContext), WorkContext);
