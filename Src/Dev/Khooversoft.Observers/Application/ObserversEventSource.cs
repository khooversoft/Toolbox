...
namespace Khooversoft.Observers
{
    ...
    public sealed class ObserversEventSource : EventSource, IEventLog
    {
        /// <summary>
        /// Singleton for ETW logging
        /// </summary>
        public static ObserversEventSource Log { get; } = new ObserversEventSource();
