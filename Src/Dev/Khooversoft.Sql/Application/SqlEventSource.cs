...
{
    [EventSource(Name = "Khooversoft.Sql")]
    public sealed class SqlEventSource : EventSource, IEventLog
    {
        /// <summary>
        /// Singleton for ETW logging
        /// </summary>
        public static SqlEventSource Log { get; } = new SqlEventSource();
