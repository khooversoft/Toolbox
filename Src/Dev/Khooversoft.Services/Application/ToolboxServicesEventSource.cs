...
{
    [EventSource(Name = "Khooversoft.Services")]
    public class ServicesEventSource : EventSource, IEventLog
    {
        /// <summary>
        /// Singleton for logging
        /// </summary>
        public static ServicesEventSource Log { get; } = new ServicesEventSource();
