...
{
    [EventSource(Name = "Khooversoft.Security")]
    public sealed class SecurityEventSource : EventSource, IEventLog
    {
        /// <summary>
        /// Singleton for ETW logging
        /// </summary>
        public static SecurityEventSource Log { get; } = new SecurityEventSource();
